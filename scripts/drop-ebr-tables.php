...
$pdo = ebr_pg_pdo();
foreach (['ebr_batch_presence', 'ebr_batch_collaborators', 'ebr_data_entries', 'ebr_batch_records', 'ebr_forms', 'ebr_user_preferences', 'ebr_active_users', 'ebr_pdf_templates'] as $table) {
